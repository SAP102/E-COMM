...
export default function DeletePopup({ id, setDelPage, delPage, picture, name }) {
  ...
  return (
    <>
      ...
      <div
        aria-live="assertive"
        className="pointer-events-none fixed inset-0 flex items-end px-4 py-6 mt-[3%] sm:items-start sm:p-6"
      >
